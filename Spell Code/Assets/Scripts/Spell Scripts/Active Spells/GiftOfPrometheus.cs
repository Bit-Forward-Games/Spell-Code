...
public class GiftOfPrometheus : SpellData
{
    public GiftOfPrometheus()
    {
        ...
        description = "Spawn flames at your feet. This Spellcode deals damage over time to those in it. This Spellcode's duration increases with Reps<sprite name=\"Reps\">.";
