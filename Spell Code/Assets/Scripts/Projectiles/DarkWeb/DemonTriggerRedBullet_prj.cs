...
public class DemonTriggerRedBullet_prj : BaseProjectile
{

    protected override void InitializeDefaults()
    {
        projName = "Demon Trigger Red Bullet";
        //hSpeed = 3f;
        //vSpeed = 0f;
        lifeSpan = 30; 
        deleteOnHit = true;
    ...
    {
        base.SpawnProjectile(facingRight, spawnOffset, "Demon Trigger Red Bullet", useAbsolutePosition);
