...
public class GameManager : MonoBehaviour/*NonPersistantSingleton<GameManager>*/
{
    ...
    public void UpdatePlayerBounties()
    {
        ...
        VFX_Manager.Instance.PlayVisualEffect(VisualEffects.BOUNTY_AURA, players[playerWithHighestBountyIndex].position + FixedVec2.FromFloat(0f, 104.5f), playerWithHighestBountyIndex + 1, true, players[playerWithHighestBountyIndex].gameObject.transform);
    }
