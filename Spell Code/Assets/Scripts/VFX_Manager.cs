...
{
    DASH_DUST, BOUNTY_AURA, DEMON_AURA, STOCK_AURA, FLOW_STATE_AURA, REPS_AURA, DAMAGE, JUMP_DUST, DEATH, VWAVE_FLOPPY_SPAWN, KILLEEZ_FLOPPY_SPAWN, DEMONX_FLOPPY_SPAWN, BIGSTOX_FLOPPY_SPAWN
}
