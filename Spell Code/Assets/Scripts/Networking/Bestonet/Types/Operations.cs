...
namespace BestoNet.Types
{
    ...
    internal static class Operations<T> where T : struct
    {
        ...
        public static T Sqrt(T a)
        {
            ...
            // Fixed32 uses the bit-exact integer implementation. Fixed16/Fixed64 still round-trip
            // through float below -- they have no integer Sqrt yet, so keep them out of sim code.
