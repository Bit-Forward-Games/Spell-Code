...
{
    public static int flowStateCost = 60;
    public NoScopeShot()
    {
        ...
        description = $"While in Flow State<sprite name=\"FlowState\">, basic attack consumes {flowStateCost/60} second of Flow State<sprite name=\"FlowState\"> to become a long-range shot.";
