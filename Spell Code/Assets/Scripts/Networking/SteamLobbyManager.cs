...
public class SteamLobbyManager : MonoBehaviour
{
    ...
    private const string NetcodeVersion = "scz-36"; // scz-36: online Chaos uses deterministic six-spell lobby/shop loadouts, permits all six pickups, clears them each round, and hashes the mode/shop lock state
